...
export const experiencesArr = [
  {
    ...
    desc: "Integrated finance APIs like Plaid and Quickbooks in the application to automate the syncing of banking and business accounts.Created webhooks for the finance APIs to facilitate real-time data transfer, processing and maintenance for future purposes.",
    skills: [
      "ReactJS",
      "Redux",
      "NodeJs",
